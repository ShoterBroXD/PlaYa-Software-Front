...
import { RegisterRequest, ProfileRole } from '@core/models/user.model';
		...
		<div class="auth-shell">
			<div class="auth-card">
				...
				<form [formGroup]="registerForm" (ngSubmit)="onSubmit()">
					<label for="nickname" class="field-label">Apodo</label>
					<input
						id="nickname"
						type="text"
						formControlName="nickname"
						class="field-input"
						placeholder="Coloque su apodo..."
						[class.has-error]="inputInvalid('nickname')"
						autocomplete="nickname"
						required
					/>
					@if (inputInvalid('nickname')) {
						<p class="field-error">Ingresa un apodo o nombre artistico.</p>
					}
					...
					<input
						...
						class="field-input"
						placeholder="Coloque un correo valido..."
					...
					<input
						...
						class="field-input"
						placeholder="Coloque una contrasena..."
				...
				<div class="links">
					<p>
						...
						<a routerLink="/login">Inicia sesion en PlaYa!</a>
					</p>
				</div>
			</div>
		</div>
...
export class RegisterComponent {
	...
	inputInvalid(controlName: 'nickname' | 'email' | 'password'): boolean {
